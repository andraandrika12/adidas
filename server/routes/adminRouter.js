...
router.patch("/products/:id", authorizationProduct, Controller.patchProduct);
router.delete("/products/:id", authorizationProduct, Controller.deleteProduct);
router.get("/category", Controller.getCategory);
router.get("/category/:id", Controller.getOneCategory);
router.post("/category", Controller.addCategory);
router.patch("/category/:id", authorizationCategory, Controller.patchCategory);
router.delete("/category/:id", authorizationCategory, Controller.deleteCategory);
