...
class Controller {
  ...
  static async addProduct(req, res, next) {
    ...
    const { name, description, price, mainImg, categoryId, newImage1, newImage2, newImage3 } = req.body;
  ...
  static async patchProduct(req, res, next) {
    ...
    try {
      ...
      await Product.update({ name, slug, description, price, mainImg, categoryId },
        {
          where: { id: id },
          transaction: transaction
        }
